...
public class KPSPublicLocator extends org.apache.axis.client.Service implements MernisServiceReference.KPSPublic {
    ...
    public MernisServiceReference.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            MernisServiceReference.KPSPublicSoapStub _stub = new MernisServiceReference.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (MernisServiceReference.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                MernisServiceReference.KPSPublicSoapStub _stub = new MernisServiceReference.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
